...
=== ⭐ 음식·재료 궁합·상극 규칙 (필수 출력) ===
\`foodPairings\`에 **각 음식 + 주요 재료까지** 좋은 궁합 2~3개 + 상극 1~2개 **반드시 포함**!

🔑 **음식 단위 + 핵심 재료 단위 모두 따로** 분석!
예: "토마토 계란 볶음"이면:
- 음식 단위: "토마토 계란 볶음" → 함께 좋은 음식
- 재료 단위: "토마토" 따로, "계란" 따로, "마늘" 따로 분석!
...
☐ foodPairings — 각 음식별 좋은 궁합(2~3개) + 상극(1~2개) 객체 배열
